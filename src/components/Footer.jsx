  ...
  return (
    <footer class="text-gray-600 body-font dark:text-gray-400 dark:bg-gray-900">
      <div class="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
        ...
        <p class="text-sm text-gray-500 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4 dark:text-gray-400 dark:sm:border-gray-800">© 2024 AananditaDiwan </p>
        <span class="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
          <a href="https://www.linkedin.com/in/aananditadiwan" class="text-gray-500 dark:text-gray-400" target="_blank" rel="noreferrer">
